            ...
            <div class="row g-0">
                <div class="col">
                    <div class="card-body">
                        ...
                        <div class="row mb-1">
                            <div class="col-sm">
                                <h5 class="text-center">Editar Servidor</h5>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm">
                                <input class="form-control" id="nome" onblur="validaNome(this)" name="nome" type="text" placeholder="Nome">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-11">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm">
                                <?php echo $this->Form->control('Establishment', ['options' => $establishments, 'id' => 'establishment-id', 'name' => 'establishment_id', 'class' => 'form-select']); ?>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm">
                            ...
                            <div class="col-sm d-flex justify-content-end">
                                <a class="btn btn-outline-danger" href="/establishments/view/<?= $employee['establishment_id'] ?>">Cancelar</a>
                            </div>
                        </div>
                        <?= $this->Form->end() ?>
                    </div>
...
<script type="text/javascript">
    ...
    function preencheCampos() {
        ...
        $('#telefone').val("<?= $employee['telefone'] ?>");
        $('#email').val("<?= $employee['email'] ?>");
        $('#dataDeNascimento').val("<?= $employee['dataDeNascimento'] ?>");
        $('#establishment-id').attr("selected", true).val("<?= $employee['establishment_id'] ?>");
        liberaZap();
        setTimeout(focoIncial, 500);
        calculaData(document.getElementById('dataDeNascimento'));
        setTimeout(focoIncial, 500);
    }
